...
window.addEventListener('load', function(e){
	...
	// var el2 = document.getElementById('touch-icon') 
	ontouch(el ,function(evt, dir, phase, swipetype, distance){
		...
		if($(window).width()>767){
			if($('.flexslider').hasClass('swap')){
		if(dir == "left") {
			 
			 $('.flexslider').flexslider("next");
			 // $('.flex-active-slide img').click(function(){
			  // $('.flexslider').flexslider("next");	
			 // }) 
		}
		else if( dir== "right"){
	...
	// ontouch(el2 ,function(evt, dir, phase, swipetype, distance){
// 	 
// 		
		// if(dir == "left") {
			 // $('.flexslider').flexslider("next");
